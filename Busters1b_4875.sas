* This program is called Busters1b_4875.SAS ;
...
* The next block of code mean-replaces the missing value of Pop_45to50;
DATA BUSTERS3;
  SET BUSTERS2;
  IF Pop_45to50 = . THEN Pop_45to50 = 156.68;
  RUN;

* The next block of code re-computes the 5 basic summary statistics and CV for all variables;
PROC MEANS N MEAN STDDEV MIN MAX CV MAXDEC=2;
  RUN;
